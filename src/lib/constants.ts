...
export const PLATFORMS: Platform[] = [
  ...
  },
  {
    ...
    url: 'https://story-verse.vercel.app',
    status: 'live',
    category: 'business-tools',
    hasVoiceAI: true,
    featured: true,
  ...
  },
  {
    ...
    url: 'https://r-and-d-tax-eligibility-work-recording.vercel.app',
    status: 'building',
    category: 'business-tools',
    hasVoiceAI: false,
    type: 'parent',
  ...
  {
    id: 'qld-flood-support',
    name: 'Jess - QLD Flood Support',
    slug: 'qld-flood-support',
    tagline: 'Voice-first AI disaster relief assistant',
    problem: 'Disaster victims are overwhelmed and can\'t navigate complex relief systems',
    description: 'Voice-first AI assistant for Queensland flood disaster relief. Multi-agent system with specialised relief aid, financial aid, and mental health support agents. Conversational interface that guides affected residents through available support services.',
    url: 'https://qld-flood-support.vercel.app',
    status: 'building',
    category: 'voice-coaching',
    hasVoiceAI: true,
    type: 'parent',
