...
export const PLATFORMS: Platform[] = [
...

  {
    ...
    description: 'Protect your ideas before someone else does. Voice-guided IP discovery, automatic evidence capture from GitHub, trademark monitoring, patent deadline tracking, and lawyer-ready packages. Free tier with shared infrastructure, $30/mo + GST for dedicated isolation.',
